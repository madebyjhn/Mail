      ...
      {loading ? (
        ...
        <div className="flex h-screen p-4 gap-4">
          ...
          <div className="flex-1 flex flex-col gap-4">
            <motion.header className="w-full neu-flat h-18 rounded-2xl p-4 flex items-center justify-between">
              <div className="flex items-center space-x-4">
                <Button
                  variant="ghost"
                  size="sm"
                  className="neu-button rounded-xl border-0 lg:hidden theme-text-primary"
                ></Button>
